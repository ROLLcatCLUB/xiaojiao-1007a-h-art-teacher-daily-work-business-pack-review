# 1007A ART_TEACHER_DAILY_WORK_PILOT_SCOPE_CONTRACT

```text
final_status=XIAOJIAO_ART_TEACHER_DAILY_WORK_PILOT_SCOPE_CONTRACT_PASS
package_type=scope_contract
...
```text
ALL_1007A_ART_TEACHER_DAILY_WORK_PILOT_SCOPE_CONTRACT_CHECKS_OK
```
