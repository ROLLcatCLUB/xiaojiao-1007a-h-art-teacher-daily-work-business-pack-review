# 1007G ART_TEACHER_RENDER_DIRECTIVE_AND_SURFACE_MODE_FIXTURE

```text
final_status=XIAOJIAO_ART_TEACHER_RENDER_DIRECTIVE_AND_SURFACE_MODE_FIXTURE_PASS
package_type=render_directive
...
```text
ALL_1007G_ART_TEACHER_RENDER_DIRECTIVE_AND_SURFACE_MODE_FIXTURE_CHECKS_OK
```
