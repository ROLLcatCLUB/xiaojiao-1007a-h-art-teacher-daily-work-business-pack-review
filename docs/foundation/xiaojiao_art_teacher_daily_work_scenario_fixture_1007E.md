# 1007E ART_TEACHER_DAILY_WORK_SCENARIO_FIXTURE

```text
final_status=XIAOJIAO_ART_TEACHER_DAILY_WORK_SCENARIO_FIXTURE_PASS
package_type=scenario_fixture
...
```text
ALL_1007E_ART_TEACHER_DAILY_WORK_SCENARIO_FIXTURE_CHECKS_OK
```
