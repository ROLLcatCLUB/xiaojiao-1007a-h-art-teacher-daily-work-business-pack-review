# 1007H ART_TEACHER_DAILY_WORK_VERTICAL_SLICE_DRY_RUN

```text
final_status=XIAOJIAO_ART_TEACHER_DAILY_WORK_VERTICAL_SLICE_DRY_RUN_PASS
package_type=vertical_slice_dry_run
...
```text
ALL_1007H_ART_TEACHER_DAILY_WORK_VERTICAL_SLICE_DRY_RUN_CHECKS_OK
```
