# 1007B ART_TEACHER_BUSINESS_PACK_REGISTRY_FIXTURE

```text
final_status=XIAOJIAO_ART_TEACHER_BUSINESS_PACK_REGISTRY_FIXTURE_PASS
package_type=business_pack_registry
...
```text
ALL_1007B_ART_TEACHER_BUSINESS_PACK_REGISTRY_FIXTURE_CHECKS_OK
```
